...
hybird_feayure_LO/Rangenet++/train/tasks/semantic/infer.py
```
./infer.py -d /media/cyj/DATA/hybrid_feature_LO/Rangenet++/train/tasks/semantic/dataset -l /media/cyj/DATA/hybird_feature_LO/Rangenet++/train/tasks/semantic/prediction -m /media/cyj/DATA/hybrid_feature_LO/Rangenet++/train/tasks/semantic/pre_trained_model/darknet21
```
